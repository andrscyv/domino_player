...
do 
    ...
    echo $file
    python3 ../simulation.py --teams mcts_$time mcts_$strong_player_time_budget --file ${PICKLES_FOLDER_PATH}/${timestamp}_$file.pickle $num_games >> ${LOGS_FOLDER_PATH}/$log_file_name
done
